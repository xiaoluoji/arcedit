...
namespace ArcEdit
{
    class ArticlePublish_Phpcms
    {
        ...
        #region Constructors
        public ArticlePublish_Phpcms(int pubID,string coConnString,string pubConnString,string pubTablePrename,int coTypeid,int pubTypeid,int pubNums,string[]pubFilterKeywords,string randomDateStart,string randomDateStop)
        {
            _pubID = pubID;
